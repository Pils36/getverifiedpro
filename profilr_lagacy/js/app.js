    ...
    this.origin = function () {
        ...
        this.onReady = function () {
            ...
            $(".nav_link").on("click", function () {
                ...
                page = $(this).data("page");
                view = $(this).data("view");
                $(".Site-content").load("views/" + page + "_shell.html", function () {
                    ...
                    $("spcontent").load("views/" + view, function () {
        ...
        this.loadSignup = function () {
            $("#signup_content").load("views/signup.html", function () {
                $("#signup_modal").modal("show");
            });
        },
        ...
        this.onLogin = function () {
            ...
            sendRequest.postJSON(data, "helpers/loader.php", function (response) {
                ...
                if (response.data != null) {
                    ...
                    $.redirect('profile.php', {'token': response.data.jwt});
