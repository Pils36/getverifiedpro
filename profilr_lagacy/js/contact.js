    ...
    this.onReady = function () {
        ...
        this.sendMessage = function () {
            ...
            sendRequest.postJSON(data, "../helpers/loader.php", function (response) {
                ...
                $("#contact_response").html("<p style='text-align:center; color:red;'>" + response.data.response + "</p>");
                $.unblockUI();
                if (response.data.response == $.trim("Thank you for contacting us. You message will be treated appropriately")) {
