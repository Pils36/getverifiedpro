        ...
        <div class="secondary col-md-3 col-sm-12 col-xs-12">
            <aside class="info aside section">
                ...
                <?php
                    ...
                    ($count > 0) ? '<button type="button" class="btn btn-success" data-toggle="modal" data-target=".bd-example-modal-lg" style="color:#fff; width: 100%; font-size: 13px;">VERIFIED</button>' : '<button type="button" class="btn btn-danger" data-toggle="modal" data-target=".bd-example-modal-lg" style="color:#fff; width: 100%; font-size: 13px;">NOT YET VERIFIED</button>'; 
                ?>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <?php 
                            ...
                            $result = $sth->fetchAll();
                                $count = count($result);
                            // print_r($count);
                            ($count > 0) ? '<li><a href="validation">Validations</a><span class="label label-success pull-right" id="profile_validations">0</span></li><li><a href="profile_view">Profile Views</a><span class="label label-danger pull-right" id="profile_views">0</span></li>' : '<li><a id="validations" style="cursor: pointer">Validations</a><span class="label label-success pull-right" id="profile_validations">0</span></li><li><a id="views" style="cursor: pointer">Profile Views</a><span class="label label-danger pull-right" id="profile_views">0</span></li>';
                        ?>
