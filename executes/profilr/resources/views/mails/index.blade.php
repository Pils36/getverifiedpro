                          ...
                          <![endif]--> 
                                              ...
                                              <div class="column" style="width:100%;max-width:80px;display:inline-block;vertical-align:top;">
                                                <table class="contents" style="border-spacing:0; width:100%"  >
                                                  <tr>
                                                    <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:5px;" align="left"><a href="#" target="_blank"><img src="{{ asset('img/pro_exec.png') }}" alt="" width="60" height="60" style="border-width:0; max-width:60px;height:auto; display:block" align="left"/></a></td>
                                                  </tr>
                                                </table>
                                              </div>
...
{{--                       <strong>{{ $maildata->name }}</strong>,</p>
                      ...
                      Thanks, <br /> <br>
                      {{-- on behalf of <strong>{{ $maildata->company }}</strong> --}} <br />
                      We do appreciate your interest in subscribing to our Newsletter and other follow ups. <br><br>  This is the journey to be a better person. Be rest assured we have quite enormous value to render to your business at anytime.
                        <br />
                        <br />
                      </p>
                  ...
                  <tr>
                    <td class="two-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;text-align:center;font-size:0;"><!--[if (gte mso 9)|(IE)]>
                      ...
                      <div class="column" style="width:100%;max-width:350px;display:inline-block;vertical-align:top;">
                        <table class="contents" style="border-spacing:0; width:100%">
                          <tr>
                            <td width="61%" align="left" valign="middle" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><p style="color:#787777; font-size:13px; text-align:left; font-family: Verdana, Geneva, sans-serif"> Copyright &copy; <?php echo date('Y'); ?><br />
                                {{-- JSC Global<br /> --}}
                                Pro-EXECUTES</p></td>
                          </tr>
                        </table>
